...
export const SUPPORTS_IMAGE_UPLOADS: boolean = false as boolean;
...
export function EditorToolbar({
  ...
  if (uploadFiles != null) {
    parts.push(
      <PendingImageUploads key="pending-uploads" textAreaRef={textAreaRef} />
    );
